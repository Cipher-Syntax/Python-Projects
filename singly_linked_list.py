...
def main():
    ...
    while True:
        ...
        print("===================================================")
        print("1. INSERT \t 3. SORT \t 5. DELETE")
        print("2. SEARCH \t 4. UPDATE \t 6. EXIT")
        print("===================================================")
        ...
        if choice == '1':
            ...
            while True:
                print("===================================================")
                print("1. Insert at Beginning \t 3. Insert at Index")
                print("2. Insert at End \t 4. Main Menu")
                print("===================================================")
                insert_choice = input("Enter your choice (1-4): ")
            ...
            while True:
                print("===================================================")
                print("1. Delete at Beginning \t 3. Delete at Index")
                print("2. Delete at End \t 4. Main Menu")
                print("===================================================")
                delete_choice = input("Enter your choice (1-4): ")
